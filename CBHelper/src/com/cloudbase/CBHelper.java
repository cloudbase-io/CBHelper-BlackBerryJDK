...
public class CBHelper implements CBHelperResponder {
	...
	/**
	 * Executes a Shared API on demand.
	 * Results and output are parsed and handed to the responder.
	 * @param apiCode The name of the Shared API to be executed
	 ...
	 * @param responder The CBHelperResponder to handle the response value
	 */
	public void runSharedApi(String apiCode, String password, Hashtable params, CBHelperResponder responder) {
